 ...
 * @author PC
 */
public class DAOUsuariosMySQL implements IGenericDao<Usuario> {

    static Connection con;
    public static final String URL_CONEXION = "jdbc:mysql://localhost:3306/db_usuarios";

    public DAOUsuariosMySQL() throws Exception {
    ...
    public Usuario crear(Usuario usuarioNuevo) throws Exception {
        if (abrirConexion()) {//Abro conexion y compruebo que este abierta
            String sqlQuery = "INSERT INTO usuario (EMAIL, PASSWORD, NOMBRE, EDAD) VALUES ('" + usuarioNuevo.getEmail() + "', '"
